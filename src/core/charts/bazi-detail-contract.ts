...
export const BaziDetailV1Schema = z.object({
  ...
  sourceIdentity: z.object({ publicBirthRecordFingerprint: SHA256, timeEvidenceFingerprint: SHA256, baseBaziProjectionFingerprint: SHA256, targetYearsFingerprint: SHA256 }).strict(), candidates: z.array(candidate), detailFingerprint: SHA256
}).strict().superRefine((value, context) => {
...
const strictZiweiSource = z.object({
